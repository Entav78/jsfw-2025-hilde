...
export default function Product() {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 p-4 bg-white text-black rounded shadow">
      ...
      <p className="text-lg font-semibold">
        ...
        <span className="text-green-600">{product.discountedPrice} kr</span>
      </p>

      {hasDiscount && (
        <p className="text-green-600 text-sm font-medium mt-1">
          Save {(product.price - product.discountedPrice).toFixed(2)} kr!
        </p>
      )}
